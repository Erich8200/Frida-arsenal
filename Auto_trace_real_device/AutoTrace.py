...
frida_script:str = "frida_hook.js"
    ...
    def trace(self, apkPath: str, inDir: str, outDir: str):
        ...
        if os.path.exists(info_file_path):
            with open(info_file_path, "r") as file:
                ...
                s = "frida -D " + device_id + " --no-pause -f " + self.app_package_name + " -l " + frida_script + " > " + realOutDir + os.sep + "frida_trace.txt"
...
for root, dirs, files in os.walk(sampleAPKDir):
    for apk_name in files:
        ...
        if count % 40 == 0:
            print("My fellow is having a rest")
            time.sleep(60*10)
