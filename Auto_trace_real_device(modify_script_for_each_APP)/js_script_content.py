        ...
        Interceptor.attach(addrRegisterNatives, {
            onEnter: function (args) {
                ...
                for (var i = 0; i < method_count; i++) {
                    ...
                    write_file("[RegisterNatives] java_class:" + class_name + " name:" + name + " sig:" + sig + " fnPtr:" + fnPtr_ptr + " module_name:" + find_module.name + " module_base:" + find_module.base + " offset:" + ptr(fnPtr_ptr).sub(find_module.base) + " thread:" + Process.getCurrentThreadId());
